...
if (window.addEventListener) {
    window.addEventListener('load', function () {
      var canvasDraw, contextDraw, canvaso, contexto;
      ...
      function ev_canvas(ev) {
        ...
        //Test get mouse move for all different tools
        var textCoord
        textCoord = "Mouse x: " + (ev._x - 100) + "<br>" + "Mouse y: " + (ev._y - 50);
        document.getElementById("mouseCoord").innerHTML = textCoord;
      }
      ...
      function img_update() {
        contexto.drawImage(canvasDraw, 0, 0);
